...
use super::{path_to_string, DEFS_SEPARATOR};
use crate::prelude::{CobConstantValue, CobFile};
...
impl ConstantsResolver
{
    ...
    pub fn insert(&mut self, file: &CobFile, name: SmolStr, value: CobConstantValue)
    {
    ...
    pub fn append(&mut self, alias: &str, to_append: &Self)
    {
