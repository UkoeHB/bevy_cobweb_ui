...
impl Default for Panel
{
    fn default() -> Self
    {
        Self { own_id: Entity::PLACEHOLDER, title: "".into() }
    }
}
...
{
    fn panel(&mut self, title: String, spawn_children: impl FnOnce(&mut UiBuilder<Entity>)) -> UiBuilder<Entity>;
}
...
impl UiPanelExt for UiBuilder<'_, Entity>
{
    fn panel(&mut self, title: String, spawn_children: impl FnOnce(&mut UiBuilder<Entity>)) -> UiBuilder<Entity>
    {
        ...
        container.insert(Panel { own_id, title, ..default() });
