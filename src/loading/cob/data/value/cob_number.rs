...
pub enum CobNumberValue
{
    Uint(u128),
    Int(i128),
    Float64(f64),
    /// Separate from `Float64` to avoid loss of exactness when going rust -> cob number -> serialized to file.
    Float32(f32),
}
...
impl From<i8> for CobNumberValue
{
...
impl From<i16> for CobNumberValue
{
...
impl From<i32> for CobNumberValue
{
...
impl From<i64> for CobNumberValue
{
...
impl From<i128> for CobNumberValue
{
...
impl From<u8> for CobNumberValue
{
...
impl From<u16> for CobNumberValue
{
...
impl From<u32> for CobNumberValue
{
...
impl From<u64> for CobNumberValue
{
...
impl From<u128> for CobNumberValue
{
...
impl From<f32> for CobNumberValue
{
...
impl From<f64> for CobNumberValue
{
...
impl PartialEq for CobNumberValue
{
...
pub struct CobNumber
{
    pub fill: CobFill,
    pub number: CobNumberValue,
}
...
impl From<i8> for CobNumber
{
    fn from(number: i8) -> Self
    {
        Self { fill: CobFill::default(), number: number.into() }
    }
}

impl From<i16> for CobNumber
{
    fn from(number: i16) -> Self
    {
        Self { fill: CobFill::default(), number: number.into() }
